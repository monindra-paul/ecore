                    ...
                    <div class="card border-top border-0 border-4 border-danger">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-danger">Create Softwares & Drivers</h5>
                            </div>
                            <hr>
                            <form class="row g-3" action="{{ route('support.softwaresdrivers.create') }}" method="post">
                                @csrf
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0" id="name"
                                            name="name" placeholder="Softwares & Drivers Name" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="bits"
                                            name="bits" placeholder="Softwares & Drivers Bits" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="version"
                                            name="version" placeholder="Softwares & Drivers Version" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="link"
                                            name="link" placeholder="Provide the Link" />
                                    </div>
                                </div>

                                <div class="col-12">
                                    <button type="submit" class="btn btn-danger px-5">Create Softwares & Drivers</button>
                                </div>
                            </form>
                        </div>
                    </div>
