                    ...
                    <div class="card border-top border-0 border-4 border-danger">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-danger">Edit {{ $printers->name }}</h5>
                            </div>
                            <hr>
                            <form class="row g-3" action="{{ route('support.printers.update', $printers->id) }}"
                                method="get">
                                @csrf
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0" id="name"
                                            name="name" placeholder="Printer name" value="{{ $printers->name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="bits"
                                            name="bits" placeholder="Office Bits" value="{{ $printers->bits }}" />
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <select class="form-select mb-3" aria-label="Default select example" name="brand">
                                            ...
                                            <option {{ $printers->brand == 'Xerox' ? 'selected' : '' }} value="Xerox">
                                                Xerox</option>
                                            <option {{ $printers->brand == 'Hp' ? 'selected' : '' }} value="Hp">Hp
                                            </option>
                                            <option {{ $printers->brand == 'Epson' ? 'selected' : '' }} value="Epson">
                                                Epson</option>
                                            <option {{ $printers->brand == 'Canon' ? 'selected' : '' }} value="Canon">
                                                Canon</option>
                                            <option {{ $printers->brand == 'Brother' ? 'selected' : '' }} value="Brother">
                                                Brother</option>
                                            <option {{ $printers->brand == 'BizHub' ? 'selected' : '' }} value="BizHub">
                                                BizHub</option>
                                            <option {{ $printers->brand == 'Kyocera' ? 'selected' : '' }} value="Kyocera">
                                                Kyocera</option>
                                            <option {{ $printers->brand == 'Konica Minolta' ? 'selected' : '' }}
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="version"
                                            name="version" placeholder="Version" value="{{ $printers->version }}" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="model_no"
                                            name="model_no" placeholder="Model No." value="{{ $printers->model_no }}" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="type"
                                            name="type" placeholder="Printer type" value="{{ $printers->type }}" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="link"
                                            name="link" placeholder="Link" value="{{ $printers->link }}" />
                                    </div>
                                </div>

                                <div class="col-12">
                                    <button type="submit" class="btn btn-danger px-5">Update Printers</button>
                                </div>
                            </form>
                        </div>
                    </div>
