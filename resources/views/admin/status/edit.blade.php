    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Bill Edit</div>
                <div class="ps-3">
                    ...
                    <div class="card border-top border-0 border-4 border-danger">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-danger">Edit Bill Status</h5>
                            </div>
                            <hr>
                            <form class="row g-3" action="{{ route('bill.update', $bills->id) }}" method="get">
                                @csrf
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0" id="name"
                                            name="bill_no" placeholder="Bill No." value="{{ $bills->bill_no }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="name"
                                            name="name" placeholder="Customer Name" value="{{ $bills->name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="mobile"
                                            name="mobile" placeholder="Customer Mobile No." value="{{ $bills->mobile }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="email"
                                            name="email" placeholder="Customer Email" value="{{ $bills->email }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <select class="form-select mb-3" aria-label="Default select example"
                                            ...
                                            <option {{ $bills->item_type == 'Laptop' ? 'selected' : '' }} value="Laptop">
                                                Laptop</option>
                                            <option {{ $bills->item_type == 'Desktop' ? 'selected' : '' }}
                                                value="Desktop">
                                                Desktop</option>
                                            <option {{ $bills->item_type == 'Printer' ? 'selected' : '' }}
                                                value="Printer">
                                                Printer</option>
                                            <option {{ $bills->item_type == 'CCTV' ? 'selected' : '' }} value="CCTV">
                                                CCTV</option>
                                            {{-- <option selected>Open this select menu</option> --}}
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="device_no"
                                            name="device_no" placeholder="Device No." value="{{ $bills->device_no }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                                class='bx bxs-message'></i></span>
                                        <textarea class="form-control border-start-0" name="problem">{{ $bills->problem }}</textarea>
                                    </div>
                                </div>
                                <div class="col-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                                class='bx bxs-message'></i></span>
                                        <textarea class="form-control border-start-0" name="details">{{ $bills->details }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="amount"
                                            name="amount" placeholder="Amount" value="{{ $bills->amount }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <select class="form-select mb-3" aria-label="Default select example"
                                            ...
                                            <option {{ $bills->current_status == 'Pending' ? 'selected' : '' }}
                                                value="Pending">
                                                Pending</option>
                                            <option {{ $bills->current_status == 'Ready' ? 'selected' : '' }}
                                                value="Ready">
                                                Ready</option>
                                            <option {{ $bills->current_status == 'Not Repaired' ? 'selected' : '' }}
                                                value="Not Repaired">
                                                Not Repaired</option>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <select class="form-select mb-3" aria-label="Default select example"
                                            ...
                                            <option {{ $bills->delivery_status == 'No' ? 'selected' : '' }}
                                                value="No">
                                                No</option>
                                            <option {{ $bills->delivery_status == 'Yes' ? 'selected' : '' }}
                                                value="Yes">
                                                Yes</option>
                                            <option {{ $bills->delivery_status == 'In Process' ? 'selected' : '' }}
                                                value="In Process">
                                                In Process</option>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-danger px-5">Update Status</button>
                                </div>
                            </form>
                        </div>
                    </div>
