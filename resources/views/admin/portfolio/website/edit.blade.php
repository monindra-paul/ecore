                        ...
                        <div class="card-body p-5">
                            ...
                            <form class="row g-3" action="" method="" id="websiteportfolio" name="websiteportfolio">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0" id="name"
                                            name="name" placeholder="Website name" value="{{$websiteportfolio->name}}" />
                                            <p></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="link"
                                            name="link" placeholder="Website Link" value="{{$websiteportfolio->link}}"  />
                                            <p></p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                        ...
                                        <input type="text" class="form-control border-start-0" id="category"
                                            name="category" placeholder="Website category" value="{{$websiteportfolio->category}}"  />
                                            <p></p>
                                    </div>
                                </div>
                                {{-- <div class="col-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        <img width="250px" src="{{ asset('portfolio/website/'. $websiteportfolio->image) }}" alt="" srcset="">
                                    </div>
                                </div>
...
$.ajax({
    url: '{{route("portfolio.website.update",$websiteportfolio->id)}}',
    type: 'put',
