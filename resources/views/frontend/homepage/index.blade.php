...
<div id="wrapper_full" class="content_all_warpper">
    ...
    <div id="content" class="site-content">
        ...
        <section class="single_banner style_one">
            ...
            <div class="image_bg">
                <img src="{{ asset('assets-front/images/map-frame-2.png') }}" class="img" alt="img" width="100%">
                <!-- <img src="{{ asset('assets-front/images/ecore/home/ecore-w-map-2.webp') }}" class="img" alt="img"
                    width="95%"> -->
            ...
            {{-- <div class="image_bg_ec">
                <video id="bg-video" autoplay loop src="{{asset('assets-front/images/ecore/home/bg.mp4')}}"
                        ...
                        <div class="col-lg-8" style="padding-left: 35px;">
                            <div class="section_title type_one">
                                <div class="title_whole">
                                    <h2 class="title">
                                        ...
                                        <span style="font-size: 40px"> We are the </span>
                                        <span>

                                            <h2 style="color:#008bf9; " class="typewrite" data-period="700"
                                                data-type='[ "Website Development","Graphics Designing","Hardware Support" ]'>
                                                <span class="wrap"></span>

                                            </h2>

                                        </span>
                                        Services <span style="color:#008bf9;">Company</span>
                                    </h2>
                                </div>
                                <p>
                                    ECore TechServ provides best Website Designing services in kolkata. Get your one
                                    stop solution for Website Development, IT Support, Graphic Designing, Digital
                                    Marketing, CCTV Survelliance & Hardware Support.
                                </p>
                            </div>
                            <div class="newsteller_simple">
                                <div class="input_group">
                                    ...
                                    <a href="{{url('/about-us')}}" id="home-ec-btn" class="btn  aos-init aos-animate"
                                        data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">About Us</a>

                                    <a href="{{url('/remote-support')}}" id="home-ec-btn2"
                                        class="btn  aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200"
                                        data-aos-delay="400">Get Support</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="image">
                                ...
                                <video controls autoplay loop
                                    src="{{asset('assets-front/images/ecore/home/home-front.mp4')}}"
                                    type="video/mp4"></video>
                            ...
                            <div class="lottie">
                                ...
                                <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_3rqwsqnj.json"
                                    background="transparent" speed="1" style="width: 110%" loop=""
            ...
            <div class="container section_title abso type_one">
                <div class="row title_whole">
                    <div class="col-4"></div>
                    <h2 class="col-8 title"> ECore</h2>
                </div>
            </div>
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        <div class="icon trans">
                                            <i class="fi fi-rs-it"></i>
                                        </div>
                                        <div class="steps trans">1</div>
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/hardware-support-in-kolkata') }}">
                                                Hardware Support</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ url('/hardware-support-in-kolkata') }}" class="rd_more">
                            ...
                            <div class="service_box type_four hover_1_get hover_1 color_three">
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        ...
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/network-security-in-kolkata') }}">Network & Security</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                        <div class="line"></div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ url('/network-security-in-kolkata') }}" class="rd_more">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.60161 0H19.6641C19.9128 0 20.1512 0.0987719 20.327 0.274587C20.5028 0.450403 20.6016 0.68886 20.6016 0.9375V15C20.6016 15.2486 20.5028 15.4871 20.327 15.6629C20.1512 15.8387 19.9128 15.9375 19.6641 15.9375C19.4155 15.9375 19.177 15.8387 19.0012 15.6629C18.8254 15.4871 18.7266 15.2486 18.7266 15V3.2L1.57661 20.35C1.3989 20.5156 1.16384 20.6058 0.920961 20.6015C0.678085 20.5972 0.446354 20.4988 0.274588 20.327C0.102821 20.1553 0.00443133 19.9235 0.000146059 19.6807C-0.00413921 19.4378 0.0860148 19.2027 0.251615 19.025L17.4016 1.875H5.60161C5.35297 1.875 5.11452 1.77623 4.9387 1.60041C4.76289 1.4246 4.66411 1.18614 4.66411 0.9375C4.66411 0.68886 4.76289 0.450403 4.9387 0.274587C5.11452 0.0987719 5.35297 0 5.60161 0Z"
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="service_box type_four hover_1_get hover_1 color_three">
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        <div class="icon trans">
                                            <i class="fi fi-rs-camera-cctv"></i>
                                        </div>
                                        <div class="steps trans">3</div>
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/cctv-surveillance-in-kolkata') }}">CCTV Surveillance</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                        <div class="line"></div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ url('/cctv-surveillance-in-kolkata') }}" class="rd_more">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.60161 0H19.6641C19.9128 0 20.1512 0.0987719 20.327 0.274587C20.5028 0.450403 20.6016 0.68886 20.6016 0.9375V15C20.6016 15.2486 20.5028 15.4871 20.327 15.6629C20.1512 15.8387 19.9128 15.9375 19.6641 15.9375C19.4155 15.9375 19.177 15.8387 19.0012 15.6629C18.8254 15.4871 18.7266 15.2486 18.7266 15V3.2L1.57661 20.35C1.3989 20.5156 1.16384 20.6058 0.920961 20.6015C0.678085 20.5972 0.446354 20.4988 0.274588 20.327C0.102821 20.1553 0.00443133 19.9235 0.000146059 19.6807C-0.00413921 19.4378 0.0860148 19.2027 0.251615 19.025L17.4016 1.875H5.60161C5.35297 1.875 5.11452 1.77623 4.9387 1.60041C4.76289 1.4246 4.66411 1.18614 4.66411 0.9375C4.66411 0.68886 4.76289 0.450403 4.9387 0.274587C5.11452 0.0987719 5.35297 0 5.60161 0Z"
                            ...
                            <div class="service_box type_four hover_1_get hover_1 color_three">
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        ...
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/website-development-in-kolkata') }}">Website
                                                Development</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ url('/website-development-in-kolkata') }}" class="rd_more">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.60161 0H19.6641C19.9128 0 20.1512 0.0987719 20.327 0.274587C20.5028 0.450403 20.6016 0.68886 20.6016 0.9375V15C20.6016 15.2486 20.5028 15.4871 20.327 15.6629C20.1512 15.8387 19.9128 15.9375 19.6641 15.9375C19.4155 15.9375 19.177 15.8387 19.0012 15.6629C18.8254 15.4871 18.7266 15.2486 18.7266 15V3.2L1.57661 20.35C1.3989 20.5156 1.16384 20.6058 0.920961 20.6015C0.678085 20.5972 0.446354 20.4988 0.274588 20.327C0.102821 20.1553 0.00443133 19.9235 0.000146059 19.6807C-0.00413921 19.4378 0.0860148 19.2027 0.251615 19.025L17.4016 1.875H5.60161C5.35297 1.875 5.11452 1.77623 4.9387 1.60041C4.76289 1.4246 4.66411 1.18614 4.66411 0.9375C4.66411 0.68886 4.76289 0.450403 4.9387 0.274587C5.11452 0.0987719 5.35297 0 5.60161 0Z"
                            ...
                            <div class="service_box type_four hover_1_get hover_1 color_three">
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        ...
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/digital-marketing-in-kolkata') }}">Digital Marketing</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                        <div class="line"></div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ url('/digital-marketing-in-kolkata') }}" class="rd_more">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.60161 0H19.6641C19.9128 0 20.1512 0.0987719 20.327 0.274587C20.5028 0.450403 20.6016 0.68886 20.6016 0.9375V15C20.6016 15.2486 20.5028 15.4871 20.327 15.6629C20.1512 15.8387 19.9128 15.9375 19.6641 15.9375C19.4155 15.9375 19.177 15.8387 19.0012 15.6629C18.8254 15.4871 18.7266 15.2486 18.7266 15V3.2L1.57661 20.35C1.3989 20.5156 1.16384 20.6058 0.920961 20.6015C0.678085 20.5972 0.446354 20.4988 0.274588 20.327C0.102821 20.1553 0.00443133 19.9235 0.000146059 19.6807C-0.00413921 19.4378 0.0860148 19.2027 0.251615 19.025L17.4016 1.875H5.60161C5.35297 1.875 5.11452 1.77623 4.9387 1.60041C4.76289 1.4246 4.66411 1.18614 4.66411 0.9375C4.66411 0.68886 4.76289 0.450403 4.9387 0.274587C5.11452 0.0987719 5.35297 0 5.60161 0Z"
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="service_box type_four hover_1_get hover_1 color_three">
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        <div class="icon trans">
                                            <i class="fi fi-tr-react"></i>
                                        </div>
                                        <div class="steps trans">6</div>
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/app-development-in-kolkata') }}">App Development</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                        <div class="line"></div>
                                    ...
                                    <div class="bottom">
                                        <p class="trans">
                                            ...
                                            accesibility.</p>
                                        <a href="{{ url('/app-development-in-kolkata') }}" class="rd_more">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.60161 0H19.6641C19.9128 0 20.1512 0.0987719 20.327 0.274587C20.5028 0.450403 20.6016 0.68886 20.6016 0.9375V15C20.6016 15.2486 20.5028 15.4871 20.327 15.6629C20.1512 15.8387 19.9128 15.9375 19.6641 15.9375C19.4155 15.9375 19.177 15.8387 19.0012 15.6629C18.8254 15.4871 18.7266 15.2486 18.7266 15V3.2L1.57661 20.35C1.3989 20.5156 1.16384 20.6058 0.920961 20.6015C0.678085 20.5972 0.446354 20.4988 0.274588 20.327C0.102821 20.1553 0.00443133 19.9235 0.000146059 19.6807C-0.00413921 19.4378 0.0860148 19.2027 0.251615 19.025L17.4016 1.875H5.60161C5.35297 1.875 5.11452 1.77623 4.9387 1.60041C4.76289 1.4246 4.66411 1.18614 4.66411 0.9375C4.66411 0.68886 4.76289 0.450403 4.9387 0.274587C5.11452 0.0987719 5.35297 0 5.60161 0Z"
                            ...
                            <div class="service_box type_four hover_1_get hover_1 color_three">
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        ...
                                        <div class="steps trans">6</div>
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/software-development-in-kolkata') }}">Software
                                                Development</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                    ...
                                    <div class="bottom">
                                        <p class="trans">
                                            ...
                                            software. </p>
                                        <a href="{{ url('/software-development-in-kolkata') }}" class="rd_more">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.60161 0H19.6641C19.9128 0 20.1512 0.0987719 20.327 0.274587C20.5028 0.450403 20.6016 0.68886 20.6016 0.9375V15C20.6016 15.2486 20.5028 15.4871 20.327 15.6629C20.1512 15.8387 19.9128 15.9375 19.6641 15.9375C19.4155 15.9375 19.177 15.8387 19.0012 15.6629C18.8254 15.4871 18.7266 15.2486 18.7266 15V3.2L1.57661 20.35C1.3989 20.5156 1.16384 20.6058 0.920961 20.6015C0.678085 20.5972 0.446354 20.4988 0.274588 20.327C0.102821 20.1553 0.00443133 19.9235 0.000146059 19.6807C-0.00413921 19.4378 0.0860148 19.2027 0.251615 19.025L17.4016 1.875H5.60161C5.35297 1.875 5.11452 1.77623 4.9387 1.60041C4.76289 1.4246 4.66411 1.18614 4.66411 0.9375C4.66411 0.68886 4.76289 0.450403 4.9387 0.274587C5.11452 0.0987719 5.35297 0 5.60161 0Z"
                            ...
                            <div class="service_box type_four hover_1_get hover_1 color_three">
                                ...
                                <div class="content_box trans">
                                    <div class="top">
                                        ...
                                        <div class="steps trans">6</div>
                                        <h4 class="title_24 trans">
                                            <a href="{{ url('/cloud-services-in-kolkata') }}">Cloud Services</a>
                                        </h4>
                                    </div>
                                    <div class="line_box">
                                        <div class="line"></div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ url('/cloud-services-in-kolkata') }}" class="rd_more">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.60161 0H19.6641C19.9128 0 20.1512 0.0987719 20.327 0.274587C20.5028 0.450403 20.6016 0.68886 20.6016 0.9375V15C20.6016 15.2486 20.5028 15.4871 20.327 15.6629C20.1512 15.8387 19.9128 15.9375 19.6641 15.9375C19.4155 15.9375 19.177 15.8387 19.0012 15.6629C18.8254 15.4871 18.7266 15.2486 18.7266 15V3.2L1.57661 20.35C1.3989 20.5156 1.16384 20.6058 0.920961 20.6015C0.678085 20.5972 0.446354 20.4988 0.274588 20.327C0.102821 20.1553 0.00443133 19.9235 0.000146059 19.6807C-0.00413921 19.4378 0.0860148 19.2027 0.251615 19.025L17.4016 1.875H5.60161C5.35297 1.875 5.11452 1.77623 4.9387 1.60041C4.76289 1.4246 4.66411 1.18614 4.66411 0.9375C4.66411 0.68886 4.76289 0.450403 4.9387 0.274587C5.11452 0.0987719 5.35297 0 5.60161 0Z"
                        ...
                        <div class="row">
                            <div class="col-lg-9 pd_right_70">
                                <div class="section_title type_two">
                                    ...
                                    <!---============spacing==========--->
                                    <p> Our approach to service is uniquely built around what we know works…and what we
                                        know doesn’t work. With over 100 verified sector in industry and agencies will
                                        rely on old tactics that no longer work, or guess with new tactics that they
                                        hope will stick.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="icon_box_only trans type_one type_two">
                                    <div class="icon_box_in trans">
                                        <div class="icon">
                                            <i class="fi fi-rr-leadership-alt"></i>
                                        </div>
                                        <div class="title_18">
                                            <a href="#">
                                                Expert Advice</a>
                            ...
                            <ul class="nav nav-tabs links trans" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active" id="aboutuss-tabtab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">
                                        Features <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
