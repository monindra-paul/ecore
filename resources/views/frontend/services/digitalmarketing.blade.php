        ...
        <div id="content" class="site-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="section_title type_two">
                                ...
                                <p> We bet you don’t spend much time on the 2nd page of Google – so why should your website?
                                </p>
                            </div>
                            <!---============spacing==========--->
                                ...
                                <div class="col-lg-3">
                                    <div class="icon_box_only trans type_one type_two">
                                        <div class="icon_box_in trans">
                                            ...
                                            <p>Get more website traffic, more customers & more online visibility. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="icon_box_only trans type_one type_two">
                                        <div class="icon_box_in trans">
                                            ...
                                            <p>Create, publish & promote engaging content for more traffic.
                                ...
                                <div class="col-lg-3">
                                    <div class="icon_box_only trans type_one type_two">
                                        <div class="icon_box_in trans">
                                            ...
                                            <p>You can provide the answers that your potential customers are trying.
            ...
            <section class="service-section position-relative bg_2 overflow-hidden">
                ...
                <div class="ab_img_left_top z_0 mr_top_minus_150">
                    <img src="{{ asset('assets-front/images/shape/wave-pattern-2.png') }}" class="img-fluid"
                        alt="img" />
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section_title text-center color_white type_one">
                                <h4 class="sm_title"> Digital Marketing</h4>
                                <div class="title_whole">
                                    <h2 class="title"> Build your Social Media as <br>
                                        Online Business Platform </h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12 pd_left_60">
                            <div class="section_title type_five">
                                <h4 class="sm_title"> Support
                                </h4>
                                <div class="title_whole">
                                    <h2 class="title"> What we can support ?</h2>
                                </div>

                                <p>
                                    We help you to grow your business through different startigies.
                                </p>
                            </div>
                            <!---============spacing==========--->
                                ...
                                <ul class="list_box list color_three">
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a class="links" href="#">
                                                Creating & Maintaining Google Business
                                                Manager</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a class="links" href="#">
                                                Promote Business on Google Ads
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a class="links" href="#">
                                                Making the website SEO friendly to reach
                                                maximum traffic
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a class="links" href="#">
                                                Premium Ads Campaign on Social Media
                                            </a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a class="links" href="#">
                                                Lead Generation & Market Analysis
                                            </a>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="row align-items-start">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 pd_left_30">
                            <div class="section_title type_one">
                                <h4 class="sm_title"> Search Engine Optimization - SEO</h4>
                                <div class="title_whole">
                                    <h2 class="title"> Best Search Engine Optimization SEO Services in Kolkata </h2>
                                </div>
                            </div>
                            <!---============spacing==========--->
                            ...
                            <div class="fom_tab_box custom_tabs only_tab_content">
                                <ul class="nav nav-tabs links trans" role="tablist">
                                    <li class="nav-item">
                                        <button class="nav-link active" id="aboutuss-tabtab" data-bs-toggle="tab"
                                            ...
                                            Features <svg width="12" height="12" viewBox="0 0 12 12"
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link " id="vision-tabtab" data-bs-toggle="tab"
                                            ...
                                            Advantages <svg width="12" height="12" viewBox="0 0 12 12"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 11L11 1M11 1H3.5M11 1V8.5" stroke="white" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                            </svg>
                                ...
                                <div class="s_tabs_content tab-content">
                                            ...
                                            <div class="d-flex">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span>Fast Website Load Time</span>
                                                    </li>
                                                </ul>
                                                <ul>
                                                    <li>
                                                        ...
                                                        <span> Locality search result </span>
                                                    </li>
                                                    <li>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span> Product SEO Improvement</span>
                                                    </li>
                                                    <li>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <span> Search Result Page Improvement</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane  " id="vision" role="tabpanel"
                                        aria-labelledby="vision-tabtab">
                                        <div class="tab_content_box">
                                            <div class="content">
                                                Find Search Engine Optimization SEO services with affordable budget
                                            </div>
                                            <div class="d-flex">
                                                <div class="block_faq">
                                                    <div class="accordion-box">
                                                        <div class="accordion">
                                                            <div class="question  faq_header">
                                                                <div class="question_box ">
                                                                    <div class="title_no_a_18 trans">Budget Friendly
                                                                    </div>
                                                                    <span
                                                            ...
                                                            <div class="answer accordion-content">
                                                                ECore TechServ is one of the website who provides very low
                                                                cost SMO services
                                                            </div>
                                                        </div>
                                                        <div class="accordion  active-block">
                                                            <div class="question faq_header active">
                                                                <div class="question_box">
                                                                    <div class="title_no_a_18 trans">Identity on Search
                                                                        Engines
                                                                    </div>
                                                                    <span
                                                                        class="icon_fq trans fi-rs-arrow-small-right"></span>
                                                            ...
                                                            <div class="answer accordion-content current">
                                                                We provide modern technologies that helps to build identity
                                                                on Search Engines.
                                                            </div>
                                                        </div>
                                                        <div class="accordion">
                                                            ...
                                                            <div class="answer accordion-content">
                                                                We use updated version of languages and modern technologies
                                                                to perform best.
                                                            </div>
                                                        </div>
                                                        <div class="accordion">
                                                            ...
                                                            <div class="answer accordion-content">
                                                                Get your brand popular in the world with SEO service. You
                                                                can start your service with affordable prices from ECore
                                                                TechServ.
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section_title text-center type_one">
                                ...
                                <div class="title_whole">
                                    <h2 class="title"> Popular Pricing Plan For <br> Insurance Services </h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="price_box type_one trans">
                                <div class="top">
                                    <h4 class="title_24">
                                        <a class="links" href="#"> Regular Plan </a>
                                    </h4>
                                    <div class="price">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="price_box type_one trans">
                                <div class="top">
                                    <h4 class="title_24">
                                        <a class="links" href="#"> Golden Plan </a>
                                    </h4>
                                    <div class="price">
