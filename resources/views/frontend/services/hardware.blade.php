            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="image_box_only  type_two">
                        ...
                        <div class="left">
                            <div class="image one">
                                <img src="{{ asset('assets-front/images/portfolio/project-1-min.png') }}" alt="img"
                                    class="img-fluid">
                            </div>
                            <div class="image two">
                                <img src="{{ asset('assets-front/images/form-2-min.png') }}" alt="img"
                                    class="img-fluid">
                        ...
                        <div class="right">
                            <div class="image three">
                                <img src="{{ asset('assets-front/images/form-1-min.png') }}" alt="img"
                                    class="img-fluid">
                            </div>
                            <div class="image four">
                                <img src="{{ asset('assets-front/images/logo-rotate.png') }}" alt="img"
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
