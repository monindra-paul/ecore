...
<footer class="footer style_one style_two">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="footer_widgets_box pd_bottom_30">
                                ...
                                <div class="fwidget_title">
                                    <h2 class="title color_white"> Other Pages </h2>
                                    <!---============spacing==========--->
                                    <div class="pd_bottom_25"></div>
                                    <!---============spacing==========--->
                                </div>
                    ...
                    <div class="position-relative">
                        <ul class="list_box linline">
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="icon trans">
                                        <img src="{{ asset('assets-front/images/shield.svg') }}" class="img-fluid"
                                            alt="img" />
                                    </div>
                                    <a class="links color_white" href="#">
    ...
    <div class="patter_bottom">
        <img src="{{ asset('assets-front/images/shape/wave-pattern-1.png') }}" class="img-fluid" alt="img" />
    </div>
</footer>
<!--footer  end-->
<!----==============mobile_menu_box ==============--->
<div class="mobile_menu_box">
    ...
    <nav class="menu-box scrollbarcolor">
        ...
        <div class="mobile-header-info-wrap">
            ...
            <div class="single-mobile-header-info">
                <a href="#" class="theme_btn">Service</a>
            </div>
        </div>
...
<div class="prgoress_indicator color_two">
